        ...
        <div className="max-w-6xl mx-auto px-8 py-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-brand-50 border border-brand-200 rounded-lg p-6">
              <div className="text-sm text-brand-600 font-medium mb-1">총 Task</div>
              <div className="text-3xl font-bold text-brand-900">{totalElements}</div>
            </div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent"
